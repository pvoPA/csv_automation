...
from export_host_applications_csv import etl_host_applications_csv
...
from export_registry_image_application_csv import etl_registry_image_application_csv
from export_registry_image_vulnerability_csv import (
    etl_registry_image_vulnerability_csv,
)
from export_tanzu_blobstore_application_csv import etl_tanzu_blobstore_applications_csv
from export_tanzu_blobstore_vulnerability_csv import (
    etl_tanzu_blobstore_vulnerabilities_csv,
)
from export_tas_applications_csv import etl_tas_application_csv
...
def main(data="", context=""):
    ...
    logger.info("\tCreating tas applications CSV...")
    etl_tas_application_csv()

    ###########################################################################
    logger.info("Creating Nexus Repository applications CSV...")
